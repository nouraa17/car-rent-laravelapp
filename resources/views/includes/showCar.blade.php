@section('title2')
{{$car->formatted_created_at}}
@endsection
<div class="site-section">
  <div class="container">
    <div class="row">
      <div class="col-md-8 blog-content">
        <img src="{{asset('assets/carsimgs/'.$car->image)}}" alt="" class="img-fluid p-3 mb-5 bg-white rounded">
        ...
        <div class="pt-5">
          <p>Category: {{$car->category['cat_name']}}</p>
        </div>
      ...
      <div class="col-md-4 sidebar">
        ...
        <div class="sidebar-box">
          <div class="categories">
            ...
            <li><a href="#">{{$category->cat_name}}<span>{{$category->cars_count}}</span></a></li>
            @endforeach
          </div>
        </div>
        <div class="sidebar-box">
